...
<main class="container-fluid">
    ...
    <section id="coupon" class="row custom-margin">
        <div class="col-md-8 offset-md-2">
            <div class="row rounded border-style">
                <div class="col-md-6 d-flex justify-content-center flex-column p-5 ">
                    <h1 class="">{{ $coupon->discount }} % OFF </h1>
                    <h2>YOUR PURCHASE FOR ALL PRODUCTS </h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis eos impedit minima odit ut! At
                        beatae debitis doloribus error eum, excepturi facere facilis id, minima pariatur reprehenderit
                        sequi tenetur voluptate.</p>
                    <p class="fw-bold">Use Coupon Code: </p>
                    <p class="fw-bold fa-2x">{{ $coupon->code }}</p>
                </div>
                <div class="col-md-6 d-none d-md-block">
                    <img class="img-fluid p-5" src="{{asset('images/frontend/coupon.PNG')}}" alt="coupon">
                </div>
            </div>
        </div>
    </section>
